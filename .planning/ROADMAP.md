...
- [x] 16.1-04-PLAN.md — Gap closure: fix status case mismatch ('Final' vs 'final') in normalizeBDLStatus + DB correction + pipeline re-run
...
| 16.1 Bug Fixes | 4/4 | Complete   | 2026-03-23 |
